...
def max_depth_helper(root: Optional[TreeNode], current_depth):
    if root is None:
        return current_depth
    l_depth = max_depth_helper(root.left, current_depth)
    r_depth = max_depth_helper(root.right, current_depth)
...
class Solution:
    def maxDepth(self, root: Optional[TreeNode]) -> int:
        ...
        return max_depth_helper(root, current_depth=0)
